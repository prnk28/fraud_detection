      ...
      <header className="App-header">
        ...
        <form>
          ...
          <div class="form-group">
            <label for="exampleFormControlInput1">Choose JSON File</label>
            <input type="file" placeholder="Choose JSON File" class="form-control-file" id="exampleFormControlFile1"></input>

          </div>
          <div class="form-group">
            <label for="exampleFormControlTextarea1">Raw Data</label>
            <textarea class="form-control" id="rawData" rows="8" placeholder="       [{
          Time: 0,
          V1: -1.3598071336738,
          V2: -0.0727811733098497,
          V3: 2.53634673796914,
